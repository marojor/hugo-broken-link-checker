...
RUN wget https://github.com/gohugoio/hugo/releases/download/v0.101.0/hugo_extended_0.101.0_Linux-64bit.tar.gz
RUN tar xvzf hugo_extended_0.101.0_Linux-64bit.tar.gz
